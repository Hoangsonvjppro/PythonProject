...
from app.models.models import db, User, ChatRoom, RoomParticipant, Message, StatusPost, PostComment
...
# Chức năng mới: Mời người dùng vào phòng chat
...
# Chức năng mới: Xóa người dùng khỏi phòng chat
